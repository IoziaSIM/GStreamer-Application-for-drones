...
default = False
rate_0 = [0.34, 0.33, 0.33]  # initial weights for the channels
rep_0 = [0.0, 0.0, 1.0]  # initial coding rate
index = 7  # index of efficient class, to change if there are a different number of channels
#end changes
alfa = 1
